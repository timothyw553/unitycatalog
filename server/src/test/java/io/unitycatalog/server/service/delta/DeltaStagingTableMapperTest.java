...
public class DeltaStagingTableMapperTest {
  ...
  public void testHappyPathMapping() {
    ...
    assertThat(resp.getRequiredProperties()).containsEntry("io.unitycatalog.tableId", info.getId());
  }
  ...
  public void testNullPropertyValuesSurviveRoundTrip() throws Exception {
    ...
    assertThat(json)
        .contains("\"delta.inCommitTimestampEnablementVersion\":null")
        .contains("\"delta.inCommitTimestampEnablementTimestamp\":null")
        .contains("\"delta.rowTracking.materializedRowIdColumnName\":null")
        .contains("\"delta.rowTracking.materializedRowCommitVersionColumnName\":null");
